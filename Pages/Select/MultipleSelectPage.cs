...
namespace QaPracticeTest.Pages.Select
{
    ...
    {
        public ILocator PlaceSelect => Page.Locator("#id_choose_the_place_you_want_to_go");
        public ILocator HowSelect => Page.Locator("#id_choose_how_you_want_to_get_there");
        public ILocator WhenSelect => Page.Locator("#id_choose_when_you_want_to_go");
        public ILocator PlaceSelectLabel => Page.Locator($"[for={PlaceSelect.GetAttributeAsync("id").Result}]");
        public ILocator HowSelectLabel => Page.Locator($"[for={HowSelect.GetAttributeAsync("id").Result}]");
        public ILocator WhenSelectLabel => Page.Locator($"[for={WhenSelect.GetAttributeAsync("id").Result}]");
